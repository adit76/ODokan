...
$product_image_one= DB::table('interior_design_image')->where('interior_design_product_id',$id)->first();
$product_image= DB::table('interior_design_image')->where('interior_design_product_id',$id)->get();
?>
...
<div class="container products_details_container">
		<div class="card">
            ...
            <ul class="preview-thumbnail nav nav-tabs">
              <?php
                ...
                ?>
						  ...
						  <li><a data-target="#myCarousel" data-slide-to="{{$j++}}"><img src="/interior_design_images/{{$image->interior_design_product_image}}" /></a></li>
              ...
              <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  ...
                  <div class="item active">
                    ...
                    <div class="tab-pane active" id="pic-0"><img src="/interior_design_images/{{$product_image_one->interior_design_product_image}}" /></div>
                  ...
                  $k=1;
                   ...
                   ?>
                   <div class="item">
                    <div class="tab-pane" id="pic-{{$k++}}"><img src="/interior_design_images/{{$images->interior_design_product_image}}" /></div>
                  </div>
                  <?php
                ...
                <a class="right carousel-control" href="#myCarousel" data-slide="next">
                  ...
                  <span class="sr-only">Next</span>
					...
					<form class="details col-md-6" id="buy_form" action="{{route('interiordesignaddtobag',['id'=>$product_detail->id])}}" method="POST">
            {{csrf_field()}}
						<h3 class="product-title">{{$product_detail->interior_design_product_name}}</h3>
                ...
                <span class="review-no"> ( <span class="rated_by"></span> Rating ) </span>
							</div>
						</div>

						<p class="product-description"><?=$product_detail->interior_design_product_description?></p>

            <!-- For price and discount
            <?php


            $mainprice= $product_detail->interior_design_product_price;

            $discountedpercentage= $product_detail->interior_design_discount_percentage;
          ...
          -->
            ...
            <input type="hidden" value="{{$product_detail->id}}" name="id" required>
            <input type="hidden" value="{{$product_detail->interior_design_product_code}}" name="code" required>


						<div class="action">
						    <button id="likebtn" class="like btn btn-default" type="button"><span class="fa fa-heart"></span></button>
							<button type="submit" class="add-to-cart btn btn-default">ADD TO BAG</button>
						</div>
					</form>
				</div>
			</div>
      ...
      <div class="tab-content">
        <div id="menu1" class="tab-pane fade in active">
          <li class="products_info list-group-item" title="Product Info">
            <?php
            $procode=substr($product_detail->interior_design_product_code,2);
             ?>
            <b>Product Code</b>: {{$procode}} <br/>
        ...
        <div id="menu2" class="tab-pane fade">
          <li class="products_details list-group-item" title="Product Details">
            {{$product_detail->interior_design_product_details}}
          </li>
  ...
  <div class="modal-dialog"  style="width: 400px;">
    ...
    <div class="modal-content">
      <div class="modal-header" style="background: #191818; color: white !important; border-bottom: 0 !important;">
        ...
        <h4 class="modal-title">{{$product_detail->interior_design_product_name}}</h4>
      </div>
        ...
        <div id="playerWrapOuter">
            <div id="playerWrap">
                <iframe class="productVideoIframe" width="400" height="400"
                    src="{{$product_detail->interior_design_youtube_link}}"
                    frameborder="0"
                ></iframe>
            </div>
        </div>
