       ...
       <div class="row">
           <div class="col-xs-12 col-sm-6 col-md-4 footers-one">
    		    <div class="footers-logo">
    		        <img src="https://s.financesonline.com/uploads/2017/01/KIBO-2-1.png" alt="Logo" style="width:120px;">
    		    </div>
	            ...
	            <a href="https://linkedin.com/"><i id="social-li" class="fa fa-linkedin-square fa-2x social"></i></a>
	            <a href="mailto:testtesttest123@gmail.com"><i id="social-em" class="fa fa-envelope-square fa-2x social"></i></a>
	        </div>
    		</div>
    	   <div class="col-xs-6 col-sm-6 col-md-2 footers-two">
    		    <h5>Mens </h5>
    		    <ul class="list-unstyled">
    			 <li><a href="contact.html">Jeans</a></li>
    			 <li><a href="about.html">Polo Shirts</a></li>
    			 <li><a href="about.html">Suits</a></li>
    			 <li><a href="about.html">T-Shirt</a></li>
    			 <li><a href="about.html">Sweaters</a></li>
    			</ul>
    		</div>
    	   <div class="col-xs-6 col-sm-6 col-md-2 footers-three">
    		    <h5>Women </h5>
    		    <ul class="list-unstyled">
    			 <li><a href="maintenance.html">Jeans</a></li>
    			 <li><a href="contact.html">Indian</a></li>
    			 <li><a href="about.html">Western</a></li>
    			 <li><a href="about.html">Sweaters</a></li>
    			 <li><a href="about.html">Shirts</a></li>
    			</ul>
    		</div>
    	   <div class="col-xs-6 col-sm-6 col-md-2 footers-four">
    		    <h5>Interior </h5>
    		    <ul class="list-unstyled">
    			 <li><a href="maintenance.html">Kitchen</a></li>
    			 <li><a href="contact.html">Bedroom</a></li>
    			 <li><a href="about.html">Decor</a></li>
    			 <li><a href="about.html">Restaurent</a></li>
            ...
            <div class="col-md-4 py-2">
                <h5 style="font-weight: 700;">Payments </h5>
                  ...
                  <div class="row payments_list">
              			 ...
              			 <li class="col-xs-2 col-sm-2 col-lg-2"><img src="https://cdn1.iconfinder.com/data/icons/payment-methods-14/512/_visa-128.png" title="Visa Card" alt="Visa Card"></li>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-md-12 pt-3">
                <p>© THIS Company 2018</p>
                <p>Created With &hearts; By Lintend Pvt. Ltd.</p>
            </div>
        </div>
    </div>
</section>
