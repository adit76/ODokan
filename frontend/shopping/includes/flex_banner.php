<div class="banner_flex_container container">
	<div class="banner_flex_container__one" style="background:url('https://66.media.tumblr.com/7d2fce7cc9c146fc8fe86e39359fcdab/tumblr_n32vfzlJer1ruu90ro6_500.jpg')">
		<!-- 500 x 500 -->
    <p> Mens Wear </p>
    ...
    <div class="banner_flex_container__two">
    	<div class="banner_flex_container__two__one">
    		    <div class="banner_flex_container__two__one__one" style="background:url('https://i.imgur.com/XCni7fa.png')">
              <p> Ladies Wear </p>
              <button class="btn"> Buy </button>
          	</div>


            <div class="banner_flex_container__two__one__two" style="background:url('https://i.imgur.com/L7XWAk5.png')" >
              <p> T-Shirts </p>
              <button class="btn"> Buy </button>
          	</div>
      	</div>

        <div class="banner_flex_container__two__two" style="background: url('https://i.imgur.com/1aOYzLk.png')">
          <p> Desired Brands </p>
          <button class="btn"> Buy </button>
        </div>
    </div>
