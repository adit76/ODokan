...
<div class="container products_details_container">
		<div class="card">
            ...
            <ul class="preview-thumbnail nav nav-tabs">
						  <li><a data-target="#myCarousel" data-slide-to="0"><img src="https://gd.image-gmkt.com/FALL-YOUTH-MEN-S-TROUSERS-PANTS-OF-COMMERCE-PIERRE-CARDIN-MEN/li/705/235/756235705.g_400-w_g.jpg" /></a></li>
              ...
              <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="item active">
                    <div class="tab-pane active" id="pic-1"><img src="https://gd.image-gmkt.com/FALL-YOUTH-MEN-S-TROUSERS-PANTS-OF-COMMERCE-PIERRE-CARDIN-MEN/li/705/235/756235705.g_400-w_g.jpg" /></div>
                  </div>

                  <div class="item">
                    <div class="tab-pane" id="pic-2"><img src="https://images-na.ssl-images-amazon.com/images/I/61WS7d81pWL.SS400.jpg" /></div>
                  </div>

                  <div class="item">
                    <div class="tab-pane" id="pic-3"><img src="https://gd.image-gmkt.com/FALL-YOUTH-MEN-S-TROUSERS-PANTS-OF-COMMERCE-PIERRE-CARDIN-MEN/li/705/235/756235705.g_400-w_g.jpg" /></div>
                  </div>
                </div>
                ...
                <a class="right carousel-control" href="#myCarousel" data-slide="next">
                  ...
                  <span class="sr-only">Next</span>
					...
					<form class="details col-md-6" id="buy_form" action="#" method="POST">
						<h3 class="product-title">jeans trousers</h3>
                ...
                <span class="review-no"> ( <span class="rated_by">41</span> Rating ) </span>
							</div>
						</div>

						<p class="product-description">Pierr Cardin Fit Jeans Autumn for Men. Available at different sizes.</p>
						<h4 class="price"><span>Rs. 500</span><span class="discount">Rs. 899</span></h4>
						<!-- <p class="vote"><strong>91%</strong> of buyers enjoyed this product! <strong>(87 votes)</strong></p> -->
            <h5 class="size_by">size by:
              <select class="form-control" class="swap_sizes" id="swap_sizes" style="max-width: 80px;" required>
            ...
            <input type="hidden" value="1" name="id" required>

						<div class="action">
							<input type="submit" class="add-to-cart btn btn-default" type="button" value="ADD TO BAG">
    ...
    <!-- <div class="product_description panel-group">
      <div class="panel panel-default">
        <div class="panel-heading hidden-md hidden-lg visible-sm visible-xs">
          <h3 class="panel-title">
            <a data-toggle="collapse" href="#collapse1"><b><span class="hidden-lg hidden-md">View</span> Products Details</b></a>
          </h3>
        </div>
        <div id="collapse1" class="hidden-xs hidden-sm visible-md visible-lg">
          <ul class="list-group">
            <li class="products_info list-group-item">
              <b>Product Code</b>: 115846 <br/>
              <b>Material/Fabric</b>: Faux Leather <br/>
              Backpack by Dev
            </li>

            <li class="product_brief list-group-item">
            ...
            <li class="product_remarks list-group-item">
              To get expected delivery date, please enter pin code in delivery information section. <br/>
              15 days free returns and exchange. <br/>
              Free shipping across all products on a minimum purchase of Rs 500. <br/>
            </li>
          </ul>
          <div class="product_code panel-footer">#12300a</div>
        </div>
      </div>
    </div> -->
      ...
      <div class="tab-content">
        ...
        <div id="menu2" class="tab-pane fade">
          <li class="products_details list-group-item" title="Product Details">
            Blue in colour, these ripped washed skinny jeans from KOOVS offer easy style and simple silhouette. These super comfy jeans can be teamed with t-shirts and a pair of amazing sneakers to look your best.
          </li>
  ...
  <div class="modal-dialog"  style="width: 400px;">
    ...
    <div class="modal-content">
      <div class="modal-header" style="background: #191818; color: white !important; border-bottom: 0 !important;">
        ...
        <h4 class="modal-title">Jeans Trousers</h4>
      </div>
        ...
        <div id="playerWrapOuter">
            <div id="playerWrap">
                <iframe class="productVideoIframe" width="400" height="400"
                    src="https://www.youtube.com/embed/lbYexXrYDiQ?start=94&controls=0&disablekb=1&loop=1&rel=0&enablejsapi=1&mode=opaque&autohide=1&wmode=transparent&modestbranding=1"
                    frameborder="0"
                ></iframe>
            </div>
        </div>
      ...
      function fillSizes(arr){
        ...
        for(let i = 0 ; i < arr.length ; i++){
          let sizeContent = `<label class="size" data-toggle="tooltip" title="`+ arr[i] +`">` + arr[i] +
                              `<input type="radio" name="size" value="` + arr[i] +`" required></input>
                            </label>`; //name = size//
        ...
        if(size == ''){ // If Size not provided loop and add all else add only the sized.
          for(let i = 0 ; i < arr.length ; i++){
            if(arr[i][2] == 0){ //If In Stock 0 - Zero - Not Available//
              ...
              colorContent = `<label class="color" style="background: `+ arr[i][1] +`;">` + `<input type="radio" name="color" value="` + arr[i][1] +`" required></input>
                                  <p>In Stock: ` + arr[i][2] + `</p>
                                </label>`;
            }
